module github.com/aaqaishtyaq/planb
...
require (
	...
	github.com/tsuru/planb v0.0.0-20171101194304-c00b3d97f325
	github.com/valyala/fasthttp v0.0.0-20160513150518-b0d76e0fc7e8
